...
public class AddBundleCartViewBackup extends RelativeLayout implements View.OnClickListener {
    ...
    public AddBundleCartViewBackup(Context context) {
        super(context);
        init(null);
    }

    public AddBundleCartViewBackup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public AddBundleCartViewBackup(Context context, AttributeSet attrs, int defStyle) {
