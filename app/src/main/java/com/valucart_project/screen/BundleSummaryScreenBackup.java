...
public class BundleSummaryScreenBackup extends FragmentActivity implements OnItemSelection {
    ...
    private void itemList() {
        ...
        tvAddMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(BundleSummaryScreenBackup.this, SuperSavorZoneScreen.class);
    ...
    public void alertRemoveItem(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(BundleSummaryScreenBackup.this);
