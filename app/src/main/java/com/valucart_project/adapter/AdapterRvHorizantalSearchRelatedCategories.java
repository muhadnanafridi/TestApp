...
public class AdapterRvHorizantalSearchRelatedCategories extends RecyclerView.Adapter<AdapterRvHorizantalSearchRelatedCategories.GroceryViewHolder> {
    private List<Grocery> horizontalGrocderyList;
    Context context;
    OnItemSelection onItemSelection;
    String nameItem = "";

    public AdapterRvHorizantalSearchRelatedCategories(List<Grocery> horizontalGrocderyList, Context context, OnItemSelection onItemSelection1) {
    ...
    public AdapterRvHorizantalSearchRelatedCategories(List<Grocery> horizontalGrocderyList, Context context, OnItemSelection onItemSelection1,String name1) {
        this.horizontalGrocderyList = horizontalGrocderyList;
        this.context = context;
        onItemSelection = onItemSelection1;
        nameItem= name1;
