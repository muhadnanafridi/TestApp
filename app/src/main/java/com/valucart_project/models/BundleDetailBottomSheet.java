...
public class BundleDetailBottomSheet implements Serializable ,Cloneable{

    public Data data = new Data();
    public BundleDetailBottomSheet clone()throws CloneNotSupportedException{
        return  (BundleDetailBottomSheet)  super.clone();
    }
    ...
    public static class Data implements Serializable ,Cloneable {
        ...
        public static class Products implements Serializable ,Cloneable {
            ...
            public ArrayList<Products> alternatives = new ArrayList<>();
            ...
            public ArrayList<Products> getAlternatives() {
                return alternatives;
            }

            public void setAlternatives(ArrayList<Products> alternatives) {
