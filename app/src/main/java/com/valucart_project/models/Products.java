...
public class Products  implements Serializable {
    ...
    public static class Data  implements Serializable {
        ...
        int subcategory_id,quantity,totalitems,bulk_quantity,inventory;
        String id,name, description,thumbnail,packaging_quantity_weight,packaging_quantity,delivery_date;
        ...
        String productType="";
        Boolean is_bulk,is_offer,is_wishList=false;
